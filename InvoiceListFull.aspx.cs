...
public partial class InvoiceListFull : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, System.Web.UI.WebControls.GridViewUpdateEventArgs e)
    {
        ...
        TextBox OriginalLocation = GridView1.Rows[e.RowIndex].FindControl("txt_OriginalLocation") as TextBox;
        ...
        SqlCommand cmd = new SqlCommand("Update dbo.tblInvoiceChemicalsSFS set InvNo='" + invNo.Text + 
            ...
            "',OriginalLocation='" + OriginalLocation.Text +
            "',ChemicalAmount='" + chemicalAmount.Text + 
