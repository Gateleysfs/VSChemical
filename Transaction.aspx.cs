...
public partial class Transaction : System.Web.UI.Page
{
    ...
    protected void DropDownListTransaction_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Transaction.aspx?transaction=" + transaction);
    }
    protected void DropDownListBarcode_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Transaction.aspx?transaction=" + Request.QueryString["transaction"] + "&barcode=" + barcode);
    }
    protected void DropDownListAmountLeft_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Transaction.aspx?transaction=" + Request.QueryString["transaction"] + "&barcode=" + Request.QueryString["barcode"] + "&amountLeft=" + amountLeft);
    }
